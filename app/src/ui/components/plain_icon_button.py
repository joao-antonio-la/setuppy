...
class PlainIconButton(ft.IconButton, BaseComponent):
    def __init__(
        self,
        ...
        **kwargs
        ...
        super().__init__(icon=icon, data=data, disabled=disabled, **kwargs)
    ...
    def apply_theme(self, theme_manager: Optional[ThemeManager]) -> None:
        ...
        self.icon_color = theme_manager.theme.TEXT
        self.height = theme_manager.ui_scale.BTN_HEIGHT
        self.width = theme_manager.ui_scale.BTN_HEIGHT
        self.style = ft.ButtonStyle(
            ...
            overlay_color=ft.Colors.with_opacity(
                color=theme_manager.theme.PRIMARY, opacity=0.2
            )
        )